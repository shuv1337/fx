...
test "credential authority uses non-secret Gateway credential slots" {
    ...
    try std.testing.expect(derive(.anthropic_fx_login, null) != null);
    try std.testing.expect(derive(.codex_login, null) != null);
    try std.testing.expect(derive(.xai_api_key, null) != null);
}
